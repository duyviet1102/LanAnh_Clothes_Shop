...
import 'package:LanAnh_FashionShop/users/model/order.dart';
...
//       note: note,
//       totalAmount: totalAmount,
//       image: DateTime.now().microsecondsSinceEpoch.toString() + "-" + imageSelectedName + "-", //unique - tạo mã duy nhất với thời gian 
//       status: "new",
//       dateTime: DateTime.now(),
//       shipmentAddress: shipmentAddress,
//       phoneNumber: phoneNumber,
...
//         if(responseBodyOfAddNewOrder["success"] == true )
//         {
//           // Fluttertoast.showToast(msg: "Your new order has been placed Succesfully");
//           //delete selected items from user cart 
//           selectedCartIDs!.forEach((eachSelectedCartItemCartID)
//           {
//             deleteSelectedItemsFromUserCartList(eachSelectedCartItemCartID);
//           });
//         }
//         else
//         {
...
//                      }
//                      else{
//                       Fluttertoast.showToast(msg: "Please attach the Transaction proof / Receipt / screenshot");
//                      }
//                   },
//                   borderRadius: BorderRadius.circular(30),
//                   child: 
