import 'package:LanAnh_FashionShop/users/controller/order_now_controller.dart';
import 'package:LanAnh_FashionShop/users/order/order_confirmation.dart';
...
//   List<String> deliverySystemNamesList = ["FedEx","DHL","United Parcel Service","Giao Hang Nhanh"] ;
//   List<String> paymentSystemNamesList = ["Apple Pay","Wire Transfer","Google Pay","Zalo Pay"] ; 
//   TextEditingController phoneNumberController = TextEditingController();
//   TextEditingController shipmentAddressController = TextEditingController();
//   TextEditingController noteToSellerController = TextEditingController();
...
//   displaySelectedItemsFromUser(){
//     return Column(
//       children: List.generate(selectedCartListItemsInfo!.length, (index){
//         Map<String,dynamic> eachSelectedItem = selectedCartListItemsInfo![index];
//          return Container(
//           margin: EdgeInsets.fromLTRB(16, index == 0 ? 16 : 8, 16, index == selectedCartListItemsInfo!.length - 1  ? 16 : 8),
//           decoration:  BoxDecoration(
//              borderRadius: BorderRadius.circular(20),
//              color: Colors.white24,
//              boxShadow: 
